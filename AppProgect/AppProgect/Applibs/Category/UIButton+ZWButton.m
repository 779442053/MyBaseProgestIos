...
NSString const *UIButton_IsShowNumBageKey = @"UIButton_IsShowNumBageKey";
NSString const *UIButton_badgeValueKey = @"UIButton_badgeValueKey";
@implementation UIButton (ZWButton)

@dynamic badgeValue, badgeBGColor, badgeTextColor, badgeFont;
@dynamic badgePadding, badgeMinSize, badgeOriginX, badgeOriginY;
@dynamic shouldHideBadgeAtZero, shouldAnimateBadge,IsShowNumBage;
...
-(BOOL) IsShowNumBage {
    NSNumber *number = objc_getAssociatedObject(self, &UIButton_IsShowNumBageKey);
    return number.boolValue;
}
- (void)setIsShowNumBage:(BOOL)IsShowNumBage
{
    NSNumber *number = [NSNumber numberWithBool:IsShowNumBage];
    objc_setAssociatedObject(self, &UIButton_IsShowNumBageKey, number, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    [self updateBadgeValueAnimated:YES];
}
