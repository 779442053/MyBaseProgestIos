...
+ (instancetype)ZW_colorWithHex:(uint32_t)hex {
    ...
    return [self ZW_colorWithRed:r green:g blue:b];
}

+ (instancetype)ZW_randomColor {
    return [UIColor ZW_colorWithRed:arc4random_uniform(256) green:arc4random_uniform(256) blue:arc4random_uniform(256)];
}
...
+ (UIColor*)ZW_gradientFromColor:(UIColor*)c1 toColor:(UIColor*)c2 withHeight:(CGFloat)height
{
